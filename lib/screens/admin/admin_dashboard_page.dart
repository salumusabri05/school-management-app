...
/// 
/// This page serves as the main interface for school administrators,
/// providing access to finance, student records, academics, staff management,
/// communication, and reports through a combination of bottom navigation,
/// top tabs, and a side drawer.
...
class _AdminDashboardPageState extends State<AdminDashboardPage> with SingleTickerProviderStateMixin {
                    ...
                    children: [
                      Expanded(
                        child: DropdownButtonFormField<String>(
                          ...
                          items: const [
                            DropdownMenuItem(value: 'collection', child: Text('Fee Collection', style: TextStyle(fontFamily: 'Nunito'))),
                            DropdownMenuItem(value: 'outstanding', child: Text('Outstanding Fees', style: TextStyle(fontFamily: 'Nunito'))),
                            DropdownMenuItem(value: 'expense', child: Text('Expenses', style: TextStyle(fontFamily: 'Nunito'))),
                            DropdownMenuItem(value: 'summary', child: Text('Financial Summary', style: TextStyle(fontFamily: 'Nunito'))),
                          ],
                          onChanged: (value) {},
                        ),
                      ),
                      ...
                      Expanded(
                        child: DropdownButtonFormField<String>(
                          ...
                          items: const [
                            DropdownMenuItem(value: 'daily', child: Text('Daily', style: TextStyle(fontFamily: 'Nunito'))),
                            DropdownMenuItem(value: 'weekly', child: Text('Weekly', style: TextStyle(fontFamily: 'Nunito'))),
                            DropdownMenuItem(value: 'monthly', child: Text('Monthly', style: TextStyle(fontFamily: 'Nunito'))),
                            DropdownMenuItem(value: 'yearly', child: Text('Yearly', style: TextStyle(fontFamily: 'Nunito'))),
                          ],
                          onChanged: (value) {},
                        ),
                      ),
  ...
  Widget _buildStudentDirectoryTab() {
    return Center(
      child: Text(
        'Student Directory Tab - Coming Soon',
        style: TextStyle(fontFamily: 'Nunito'),
      ),
    );
  }
  ...
  Widget _buildStudentAdmissionsTab() {
    return Center(
      child: Text(
        'Student Admissions Tab - Coming Soon',
        style: TextStyle(fontFamily: 'Nunito'),
      ),
    );
  }
  ...
  Widget _buildStudentAttendanceTab() {
    return Center(
      child: Text(
        'Student Attendance Tab - Coming Soon',
        style: TextStyle(fontFamily: 'Nunito'),
      ),
    );
  }
  ...
  Widget _buildStudentDisciplineTab() {
    return Center(
      child: Text(
        'Student Discipline Tab - Coming Soon',
        style: TextStyle(fontFamily: 'Nunito'),
      ),
    );
  }
  ...
  Widget _buildAcademicsResultsTab() {
    return Center(
      child: Text(
        'Academic Results Tab - Coming Soon',
        style: TextStyle(fontFamily: 'Nunito'),
      ),
    );
  }
  ...
  Widget _buildStaffAttendanceTab() {
    return Center(
      child: Text(
        'Staff Attendance Tab - Coming Soon',
        style: TextStyle(fontFamily: 'Nunito'),
      ),
    );
  }
  ...
  Widget _buildStaffEvaluationsTab() {
    return Center(
      child: Text(
        'Staff Evaluations Tab - Coming Soon',
        style: TextStyle(fontFamily: 'Nunito'),
      ),
    );
  }
